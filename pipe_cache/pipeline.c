...
int pc = 0x0;
int fin = 0;
int nr = 0, ni = 0, nj =0 , nm = 0, nt = 0, nnt = 0, njump = 0;
...
void memory()
{
	...
	case 0x29:
		...
		break;
	case 0x2B:
		M[ALUinput1 + SignExtImm] = inputr;
		break;
	case 0x23:
                Rdata = M[ALUinput1 + SignExtImm];
		break;
	default :
		break;
	}
